...
def excelToPdf(excelFile,pdfFile):
	...
	table.setStyle(TableStyle([ #属性値、開始位置、終了位置、属性
		("ALIGN",(0,0),(-1,0),"CENTER"),#行見出しを中央寄せ
		('BACKGROUND',(0,0),(-1,0),colors.lightgreen),#
		("ALIGN",(0,1),(0,-1),"RIGHT"),#日付の列を右寄せ行見出しををライトグリーンにする
		("ALIGN",(2,1),(2,-1),"RIGHT"),#売上金額のの列を右寄せ
		('TEXTCOLOR',(0,0),(1,-1),colors.black),#文字色設定
		('FONT',(0,0),(-1,-1),"GenShinGothic-Normal",20),#フォントとフォントサイズ設定
		('GRID',(0,0),(-1,-1),0.5,colors.black),]))#罫線の設定
